...
ActiveRecord::Schema.define(version: 20180128190816) do
  ...
  create_table "user_favorite_listings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["listing_id"], name: "index_user_favorite_listings_on_listing_id"
    t.index ["user_id"], name: "index_user_favorite_listings_on_user_id"
  end
